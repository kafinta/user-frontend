<template>
  <div class="flex w-full select-none">
    <NavigationSideBar :isSeller="sellerState" :username="username" :class="menu_revealed ? 'translate-x-0' : '-translate-x-full'" class="md:translate-x-0 duration-150 ease-in-out" />
