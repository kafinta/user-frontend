<template>
  ...
  <div v-else class="mt-5 text-center">
    <div class="mx-auto max-w-md rounded-3xl border border-accent-200 bg-white p-8 shadow-[0_10px_30px_rgba(15,23,42,0.04)]">
      ...
      <UiTypographyH3 class="mt-5 text-secondary font-medium">
